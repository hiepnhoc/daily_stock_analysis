...
const TITLES: Record<string, { title: UiTextKey; description: UiTextKey }> = {
  ...
  '/vn-market': { title: 'layout.route.vnMarket.title', description: 'layout.route.vnMarket.description' },
  '/vn-market/scanner': { title: 'layout.route.vnMarket.title', description: 'layout.route.vnMarket.description' },
  '/vn-market/analyze': { title: 'layout.route.vnMarket.title', description: 'layout.route.vnMarket.description' },
  '/vn-market/alerts': { title: 'layout.route.vnMarket.title', description: 'layout.route.vnMarket.description' },
  '/vn-portfolio': { title: 'layout.route.portfolio.title', description: 'layout.route.portfolio.description' },
