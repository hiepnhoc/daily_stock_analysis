...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, LineChart, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'vn-market', labelKey: 'layout.nav.vnMarket', to: '/vn-market', icon: LineChart },
  { key: 'portfolio', labelKey: 'layout.nav.portfolio', to: '/vn-portfolio', icon: BriefcaseBusiness },
